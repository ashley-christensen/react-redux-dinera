...
Additional Features: 
I hope to add login functionality and a backend server powered by Node and Express, as well as a Database (MongoDB). I would also like to add unit testing. 
